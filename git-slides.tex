...
\begin{frame}
  ...
  \column{.5\textwidth}
    ...
    \only<2>{\texttt{git branch test}}
    \only<3>{\texttt{git checkout test}}
    \only<4>{\texttt{git commit}}
    \only<5>{\texttt{git checkout master}}
    \only<6>{\texttt{git commit}}
  \column{.5\textwidth}
    \begin{figure}
      \includegraphics[width=5cm]<1>{images/git-simple-repo.png}
      \includegraphics[width=5cm]<2>{images/git-simple-repo2.png}
      \includegraphics[width=5cm]<3>{images/git-simple-repo3.png}
      \includegraphics[width=5cm]<4>{images/git-simple-repo4.png}
      \includegraphics[width=5cm]<5>{images/git-simple-repo5.png}
      \includegraphics[width=5cm]<6>{images/git-simple-repo6.png}
    \end{figure}
  \end{columns}
\end{frame}
